...
class RoyalRoadProvider : MainAPI() {
    override val name = "MTLARCHIVE"
    override val mainUrl = "https://www.mtlarchive.com"
    override val rateLimitTime = 500L
    override val hasMainPage = true

    override val iconId = R.drawable.big_icon_mtlarchive

    override val iconBackgroundId = R.color.mtlarchiveColor
